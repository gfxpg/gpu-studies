...
class Sphere : public Surface {
 public:
  ...
  virtual std::optional<SurfaceHit> hit(const Ray& r, float t_min,
    ...
    // First try the smaller t (closer to the camera)
